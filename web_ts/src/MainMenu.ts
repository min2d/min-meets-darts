...
export default class MainMenu extends MuBase {
	...
	create() {
		...
		// set logo
		var style = {fill: "#1d043f", align: "center",boundsAlignH: "center", font: 140 +"px ProstOne"};
		this.logo =  this.add.text(this.world.width/2, -100, "titletext", style);	
		this.logo.anchor.setTo(0.5, 0.5);
		this.add.tween(this.logo).to({ y: this.world.height*0.45 }, 2000, Phaser.Easing.Elastic.Out, true, 1000);

		//info text
		var style2 = {align: "center",boundsAlignH: "center", boundsAlignV: "middle", font:60 + "px ProstOne"};
